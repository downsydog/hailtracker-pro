...
export function DealershipApiPage() {
  ...
  const usagePercent = ((apiUsage.requests_total ?? 0) / (apiUsage.requests_limit ?? 1)) * 100
              ...
              {(apiUsage.endpoints ?? []).map((endpoint, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-right font-medium">
                    {(endpoint.calls ?? 0).toLocaleString()}
                  </TableCell>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  {(apiUsage.requests_limit ?? 0).toLocaleString()} requests/month
                </p>
              </div>
            </div>
