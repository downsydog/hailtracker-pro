        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-4">
              ...
              <div className="p-4 bg-muted rounded-lg text-center">
                <Progress
                  value={(uploadResult.imported / uploadResult.total_rows) * 100}
                  className="mt-2"
                />
                <div className="text-sm text-muted-foreground mt-1">
                  {((uploadResult.imported / uploadResult.total_rows) * 100).toFixed(0)}% Success
                </div>
              </div>
            </div>
            ...
            {uploadResult.vehicles.length > 0 && (
              <div>
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  {uploadResult.vehicles.length > 5 && (
                    <div className="p-3 text-center text-sm text-muted-foreground bg-muted">
                      And {uploadResult.vehicles.length - 5} more vehicles...
                    </div>
                  )}
                </div>
              </div>
