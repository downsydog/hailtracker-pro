        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold">{data.active_jobs.length}</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold">{data.completed_jobs.length}</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold">{data.upcoming_appointments.length}</p>
