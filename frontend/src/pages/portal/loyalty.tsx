...
export function PortalLoyaltyPage() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Lifetime: {(loyalty.lifetime_points ?? 0).toLocaleString()} points earned
              </p>
            </div>
          ...
          {loyalty.tier !== 'PLATINUM' && (
            <div className="mt-6">
              <div className="flex justify-between text-sm mb-2">
                ...
                <span>{(loyalty.next_tier_points ?? 0) - loyalty.points} points to go</span>
              </div>
              <Progress value={loyalty.tier_progress ?? 0} className="h-2" />
            </div>
          )}
        </CardContent>
      </Card>
      ...
      {(loyalty.available_rewards?.length ?? 0) === 0 ? (
        <Card>
      ...
      {(loyalty.point_history?.length ?? 0) === 0 ? (
        <Card>
